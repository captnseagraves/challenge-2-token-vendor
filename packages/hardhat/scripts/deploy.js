...
const main = async () => {
  ...
  // const result = await yourToken.transfer( "0x037899482fbfE991e80eaEF9FB980bf2992958Fd", utils.parseEther("1000") );
  ...
  await vendor.transferOwnership( "0x037899482fbfE991e80eaEF9FB980bf2992958Fd" );
